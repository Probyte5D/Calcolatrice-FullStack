...
import './HomePage.css';
import { FaCalculator } from 'react-icons/fa'; // fa = Font Awesome
import { FaHome, FaEquals, FaBackspace, FaPlus, FaMinus, FaDivide, FaTimes } from 'react-icons/fa';
  ...
  return (
    <div className="home-page">
      ...
      <header className="header">
        ...
        <h1><FaCalculator />Calcolatrice React!</h1>
